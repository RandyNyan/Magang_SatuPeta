...
@section('title', 'Edit Kategori Peta')
...
<div class="space-y-6 max-w-md mx-auto bg-white p-6 rounded-xl border border-gray-100 shadow-[0_1px_3px_rgba(0,0,0,0.02)]">
    ...
    <div>
        <h2 class="text-xl font-bold text-gray-800 tracking-tight">Edit Kategori</h2>
        <p class="text-xs text-gray-500">Sesuaikan nama kategori yang sudah terdaftar.</p>
    </div>

    <form action="{{ route('manajemen.konten.kategori.update', $kategori->id) }}" method="POST" class="space-y-4">
        @csrf
