...
<head>
    ...
    <title>Semua Berita - Smart Facility Map</title>
    ...
    <section class="pt-28 pb-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="mb-10">
                ...
                <h1 class="text-3xl font-bold text-gray-900 border-l-4 border-blue-600 pl-3">Semua Berita & Pengumuman</h1>
                <p class="text-gray-500 mt-2">Informasi terbaru seputar perkembangan data geospasial Jawa Timur</p>
            </div>
