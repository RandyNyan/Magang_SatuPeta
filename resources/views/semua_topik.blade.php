...
<head>
    ...
    <title>Semua Topik - Smart Facility Map</title>
    ...
    <section class="pt-28 pb-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="mb-10">
                ...
                <h1 class="text-3xl font-bold text-gray-900 border-l-4 border-blue-600 pl-3">Semua Topik</h1>
                <p class="text-gray-500 mt-2">Telusuri seluruh topik data geospasial yang tersedia</p>
            </div>
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-6">
                ...
                @empty
                <div class="col-span-full bg-white border rounded-2xl p-12 text-center text-gray-500">
